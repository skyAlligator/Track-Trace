package com.sky.tracktracebt.fastscrollrecyclerview;
...
public class FastScrollRecyclerView extends RecyclerView {
    ...
    private void setupThings() {
        //create az text data
        Set<String> sectionSet = ((FastScrollRecyclerViewInterface)getAdapter()).getLetterMapIndex().keySet();
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                if (x < sx - scaledWidth || y < sy || y > (sy + scaledHeight*sections.length))
                    ...
                    if( ((FastScrollRecyclerViewInterface)getAdapter()).getLetterMapIndex().containsKey(section.toUpperCase()) )
                        positionInData = ((FastScrollRecyclerViewInterface)getAdapter()).getLetterMapIndex().get(section.toUpperCase());
